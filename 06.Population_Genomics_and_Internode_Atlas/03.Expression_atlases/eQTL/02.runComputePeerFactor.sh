...
exp_data=/public/home/agis_xiazq/project/02.YZ/R4.PopVar/pop_expression/01.quantitative/02.subgenome_gene_expre
...
/public/home/agis_xiazq/miniconda3/envs/r_peer/bin/Rscript /public/home/agis_xiazq/Script/eQTL/peer.r ${exp_data}/YZhap_pair.stage${i}.filter.tsv ${j} results/stage_${i}
EOF
